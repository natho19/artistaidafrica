...
function aaa_register_assets() {
    ...
    wp_register_script('aaa-common', get_template_directory_uri() . '/assets/js/common.min.js', [], false, true);
    wp_register_script('aaa-acf-map', get_template_directory_uri() . '/assets/js/acf-map.js', [], false, true);
    wp_register_script('aaa-script', get_template_directory_uri() . '/assets/js/script.js', ['jquery','aaa-libs','aaa-common', 'aaa-acf-map'], false, true);

    wp_enqueue_style('aaa-style');
    
    wp_enqueue_script('aaa-script');
}
