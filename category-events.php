					...
					<div class="upcoming-item__body">
						<div class="row align-items-center">
							<div class="col-lg-5 col-xl-4">
								<div class="upcoming-item__img"><img class="img--bg" src="<?= AAA_IMG_DIR . 'event_4.jpg' ?>" alt="img" /></div>
							</div>
							<div class="col-lg-7 col-xl-8">
								<div class="upcoming-item__description">
									<h6 class="upcoming-item__title"><a href="http://localhost/artistaidafrica/event-ipsum-dolor/">The Culture of India. Rebirth</a></h6>
            ...
            <div class="col-xl-10 offset-xl-1">
				<div class="upcoming-item">
					...
					<div class="upcoming-item__body">
						<div class="row align-items-center">
							<div class="col-lg-5 col-xl-4">
								<div class="upcoming-item__img"><img class="img--bg" src="<?= AAA_IMG_DIR . 'event_5.jpg' ?>" alt="img" /></div>
							</div>
							<div class="col-lg-7 col-xl-8">
								<div class="upcoming-item__description">
									<h6 class="upcoming-item__title"><a href="http://localhost/artistaidafrica/event-ipsum-dolor/">The Culture of India. Rebirth</a></h6>
            ...
            <div class="col-xl-10 offset-xl-1">
				<div class="upcoming-item">
					...
					<div class="upcoming-item__body">
						<div class="row align-items-center">
							<div class="col-lg-5 col-xl-4">
								<div class="upcoming-item__img"><img class="img--bg" src="<?= AAA_IMG_DIR . 'event_6.jpg' ?>" alt="img" /></div>
							</div>
							<div class="col-lg-7 col-xl-8">
								<div class="upcoming-item__description">
									<h6 class="upcoming-item__title"><a href="http://localhost/artistaidafrica/event-ipsum-dolor/">The Culture of India. Rebirth</a></h6>
