					...
					<div class="col-sm-6 col-lg-3">
						...
						<nav>
							<ul class="footer-menu">
								...
								<li class="footer-menu__item"><a class="footer-menu__link" href="about.html">About</a>
								</li>
								...
								<li class="footer-menu__item"><a class="footer-menu__link" href="causes.html">Causes</a>
								</li>
							</ul>
						</nav>
						<!-- footer nav end-->
